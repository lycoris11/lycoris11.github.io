...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Mark Pinto</title>
        <meta
          name="description"
          content="I’m Mark Pinto. I live in Chicago, where I envision a better world with code."
        />
      </Head>
      <Container className="mt-16 sm:mt-32">
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://github.com/lycoris11" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
              </SocialLink>
              <SocialLink href="https://www.linkedin.com/in/mark-pinto-eng/" icon={LinkedInIcon} className="mt-4">
                Follow on LinkedIn
              </SocialLink>
              <SocialLink
                href="mailto:pinto9435@gmail.com"
                icon={MailIcon}
